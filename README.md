...
| | Status |
| --- | --- |
| The arithmetic — shortfalls, pack conversion, inbound reconstruction, rounding | Tested, 256 passing tests, no network needed |
...
256 tests, offline, well under a second. The ones that matter most:
