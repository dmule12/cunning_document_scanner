...
| | Status |
| --- | --- |
| The arithmetic — shortfalls, pack conversion, inbound reconstruction, rounding | Tested, 161 passing tests, no network needed |
...
161 tests, offline, well under a second. The ones that matter most:
