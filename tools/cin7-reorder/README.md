...
| | Status |
| --- | --- |
| The arithmetic — shortfalls, pack conversion, inbound reconstruction, rounding | Tested, 168 passing tests, no network needed |
...
168 tests, offline, well under a second. The ones that matter most:
